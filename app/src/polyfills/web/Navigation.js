      ...
      <View css={style.background}>
        <nav>
          <ul css={style.Navigation.NavList}>
            <NavItem onClick={this.changePage('index')} message={renderIndex()} css={style.Navigation.NavItem} key={0} />
...
export class NavItem extends React.Component {
  ...
  render() {
    ...
    return (
      <li key={key} onClick={onClick} role="link" tabIndex={0} onKeyPress={() => undefined}>
        {message}
      </li>
    );
  }
