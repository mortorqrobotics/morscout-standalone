...
const getCommonSrc = (...p) => "client-common/src/" + p.join("/");
...
module.exports = options => {
  ...
  const config = {
    ...
    alias: {
      // Basic Redirects
      "~": getCommonSrc("components"),
      // Global Redirects
      screen: getSrc("screens"),
      style: getSrc("style"),

      // Redux stuff
      actions: getCommonSrc("redux-state", "actions"),
      reducers: getCommonSrc("redux-state", "reducers"),
      store: getCommonSrc("redux-state", "store"),
