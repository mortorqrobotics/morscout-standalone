module.exports = function(paths, getClientEnvironment, resolveConf) {
  ...
  return {
    ...
    optimization: {
      ...
      splitChunks: {
        chunks: "async", // NEVER CHANGE (Makes the whole website blank)
        name: false
      },
    ...
    plugins: [
      ...
      argv.analyze
        ? new BundleAnalyzerPlugin({
            analyzerMode: argv.analyzeServer ? "server" : "static",
